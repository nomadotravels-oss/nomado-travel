        ...
        <div className="hidden md:flex items-center gap-9 lg:gap-11">
          {links.map(link => (
            <a
              ...
              className={` text-[12px] tracking-[0.2em] uppercase transition-colors duration-300 relative after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-px after:bg-[#F59E0B] hover:after:w-full after:transition-all after:duration-300 ${
          ...
          <a
            ...
            className={` text-[12px] tracking-[0.18em] uppercase px-6 py-2.5 border rounded-full transition-all duration-500 ${
              scrolled
          ...
          >
            {links.map((link, i) => (
              <motion.a
                ...
                className="text-4xl font-600 text-[#F5F9FD] tracking-widest uppercase"
              >
