    ...
    <>
      ...
      <main className="bg-white font-switzerland">
        ...
        <article className="max-w-3xl mx-auto px-6 md:px-12 lg:px-20 py-12 md:py-16">
          <Link href="/#journal" className="inline-flex items-center gap-1.5 text-[10px] tracking-[0.25em] font-700 uppercase text-[#6B7280] hover:text-[#D97706] transition-colors duration-300 mb-10">
