                ...
                <div key={itinerary.id} className="bg-white rounded-3xl overflow-hidden group shadow-[0_4px_24px_-4px_rgba(0,0,0,0.08)] hover:shadow-[0_16px_48px_-8px_rgba(0,0,0,0.12)] transition-all duration-500 flex flex-col">
                  ...
                  <div className="p-6 md:p-7 flex flex-col flex-1">
                    ...
                    <div className="flex items-center gap-4 mb-5 text-[#06172E]">
                      ...
                      <div title="Cabs">
                        <svg className="w-6 h-6 md:w-7 md:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M8 7h8a2 2 0 012 2v7a2 2 0 01-2 2H8a2 2 0 01-2-2V9a2 2 0 012-2zm0 0l-3 4m11-4l3 4M5 14h14M8 11h8"></path></svg>
                      </div>
                      <div title="Meals">
